...
class GameState{
  ...
  bool operator<(const GameState& other) const {
      if (this->cannibals < other.cannibals) {
          return true;
      }
      else if (this->cannibals > other.cannibals) {
          return false;
      }
      else if (this->missionaries < other.missionaries) {
          return true;
      }
      else if (this->missionaries > other.missionaries) {
          return false;
      }
      else if (!this->boatIsLeft && other.boatIsLeft) {
          return true;
      }
      else {
          return false;
